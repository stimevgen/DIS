/**
 * Small helper class to create an {@link Ext.grid.Panel}
 *
 */
Ext.define("App.components.data.Grid",{
    extend: 'Ext.grid.Panel',
    alias	: 'widget.TGrid',
    
	//requires: [
		//'App.components.data.GridToolbar',
		//'Ext.PagingToolbar',
	...
	initComponent : function () {
        ...
        App.components.data.Grid.superclass.initComponent.call(me);
    },
    ...
    initComponent: function() {
		...
		//
		//------------------------------------------------------------------------------------------------------------------------------
		//me.tbar = new App.components.GridToolbar({grid: me});
		...
		App.components.Grid.superclass.initComponent.apply(me, arguments);
    },
